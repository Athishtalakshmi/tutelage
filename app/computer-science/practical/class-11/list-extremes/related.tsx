...
export default function Related() {
  const relatedResources = [
    ...
    {
      id: 3,
      title: "Python Built-in Functions PDF",
      type: "pdf",
      url: "/resources/python-builtin-functions.pdf",
    },
    {
      id: 4,
      title: "List Operations MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-11/list-operations",
    },
    {
      id: 5,
      title: "Previous Program: List Search",
      type: "practical",
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-4 p-3 bg-[#b80877]/10 rounded-md">
        <h3 className="font-medium text-[#b80877] mb-2 text-sm">Performance Tips</h3>
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Use max()/min() for single pass efficiency</li>
          <li>• Avoid sorting for simple min/max finding</li>
          <li>• Handle empty lists with proper checks</li>
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">Try more list manipulation and algorithm programs.</p>
        <Link
