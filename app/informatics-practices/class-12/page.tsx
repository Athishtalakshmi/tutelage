...
export default function InformaticsPracticesClass11Page() {
  // Sample chapter data
  const chapters = [
    { id: 1, title: "Python Pandas 1", slug: "computer-overview" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h1 className="text-2xl font-bold mb-6 text-[#1f888f]">Informatics Practices - Class 12</h1>

              <div className="prose max-w-none">
                <p className="mb-4">
                  Welcome to the informatics Practices (065) resources for CBSE Class 12. This section provides comprehensive
                ...
                <p className="mb-4">
                  The CBSE Class 12 Informatics Practices curriculum introduces students to the fundamental concepts of
                ...
                <p className="mb-4">
                  The practical examination for Class 12 Informatices Practices tests your programming skills and
