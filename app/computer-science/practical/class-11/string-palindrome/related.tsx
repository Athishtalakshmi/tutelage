  ...
  const relatedResources = [
    {
      ...
      type: "theory",
      url: "/computer-science/class-11/strings-python",
    },
    {
      id: 2,
      title: "String Methods Tutorial",
      type: "video",
      url: "https://youtube.com/@pythontyro4579",
    },
    {
      id: 3,
      title: "String Analysis Program",
      type: "practical",
      url: "/computer-science/practical/class-11/string-analysis",
    },
    {
      id: 4,
      title: "String Module Operations",
      type: "practical",
      url: "/computer-science/practical/class-11/string-module",
    },
    {
      id: 5,
      title: "Python Strings MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-11/strings",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-4 p-3 bg-[#b80877]/10 rounded-md">
        <h3 className="font-medium text-[#b80877] mb-2 text-sm">String Tips</h3>
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Use [::-1] for quick string reversal</li>
          <li>• String methods don't modify original string</li>
          <li>• Consider case sensitivity in comparisons</li>
          <li>• Handle spaces and punctuation carefully</li>
        </ul>
      </div>

      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        <h3 className="font-medium text-[#1f888f] mb-2 text-sm">Practice More</h3>
        <p className="text-xs text-gray-600 mb-2">Try more string manipulation programs to master text processing.</p>
        <Link
