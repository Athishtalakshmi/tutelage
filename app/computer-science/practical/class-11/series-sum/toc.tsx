  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
          ...
          <li key={program.id}>
            <Link
              ...
              className={`flex items-center text-gray-700 hover:text-[#b80877] hover:bg-gray-50 p-1.5 rounded-md transition-colors text-sm ${
                program.slug === "series-sum" ? "bg-gray-50 text-[#b80877] font-medium" : ""
              }`}
            >
      ...
      <div className="mt-4 p-3 bg-[#1f888f]/10 rounded-md">
        <h3 className="font-medium text-[#1f888f] mb-2 text-sm">Series Types</h3>
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Geometric Series (1 + x + x² + ...)</li>
          <li>• Alternating Series (1 - x + x² - ...)</li>
          <li>• Rational Series (x - x²/2 + x³/3 - ...)</li>
          <li>• Factorial Series (x - x²/2! + x³/3! - ...)</li>
        </ul>
      </div>

      <div className="mt-3 p-3 bg-[#b80877]/10 rounded-md">
        <h3 className="font-medium text-[#b80877] mb-2 text-sm">Key Concepts</h3>
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Loop structures and iterations</li>
          <li>• Mathematical operations (**)</li>
          <li>• Conditional statements (if-else)</li>
          <li>• Modulo operator for alternating signs</li>
          <li>• Math module and factorial function</li>
        </ul>
      </div>
    </div>
  )
