...
export default function FlowOfControlTOC() {
  const chapters = [
    ...
    { id: 4, title: "Python Programming Fundamentals", slug: "python-programming-fundamentals" },
          ...
          <li key={chapter.id}>
            <Link
              ...
              className={`flex items-center text-gray-700 hover:text-[#b80877] hover:bg-gray-50 p-1.5 rounded-md transition-colors text-sm ${
                chapter.slug === "computer-system" ? "bg-gray-50 text-[#b80877] font-medium" : ""
              }`}
            >
