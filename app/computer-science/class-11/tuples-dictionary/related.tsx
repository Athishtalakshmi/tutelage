...
export default function TuplesDictionaryRelated() {
  const relatedResources = [
    ...
    },
    {
      ...
      type: "practical",
      url: "/computer-science/practical/class-11/dictionary-operations",
    },
    {
      id: 3,
      title: "Tuples vs Lists vs Dictionary",
      type: "pdf",
      url: "/resources/data-structures-comparison.pdf",
    },
    {
      id: 4,
      title: "Dictionary MCQs Practice",
      type: "link",
      url: "/mcqs/computer-science/class-11/dictionary",
    },
    {
      id: 5,
    ...
    {
      id: 8,
      title: "Dictionary Methods Cheat Sheet",
      type: "pdf",
      url: "/resources/dictionary-methods.pdf",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">
          Try dictionary manipulation exercises to strengthen your Python skills.
        </p>
        <Link
