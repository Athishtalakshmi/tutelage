...
export default function ComputerScienceClass11Page() {
  // Sample chapter data
  const chapters = [
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h1 className="text-2xl font-bold mb-6 text-[#1f888f]">Computer Science - Class 11</h1>

              <div className="prose max-w-none">
                <p className="mb-4">
                  Welcome to the Computer Science (083) resources for CBSE Class 11. This section provides comprehensive
                ...
                <p className="mb-4">
                  The CBSE Class 11 Computer Science curriculum introduces students to the fundamental concepts of
