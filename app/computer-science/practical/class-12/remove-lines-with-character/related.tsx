  ...
  const relatedResources = [
    {
      ...
      type: "theory",
      url: "/computer-science/class-12/data-file-handling",
    },
    {
      id: 2,
      title: "Python File Operations Tutorial",
      type: "video",
    ...
    {
      id: 4,
      title: "File Handling MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-12/file-handling",
    },
    {
      id: 5,
      title: "Text Processing Programs",
      type: "practical",
      url: "/computer-science/practical/class-12/text-file-line-by-line",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">Try similar file handling programs to strengthen your concepts.</p>
        <Link
