...
export default function IntroductionToPythonModulesTOC() {
  const chapters = [
    { id: 1, title: "Computer System Organization", slug: "computer-system-organization" },
    { id: 2, title: "Data Representation & Boolean Logic", slug: "data-representation-boolean-logic" },
    ...
    { id: 6, title: "Strings Manipulation In Python", slug: "strings-python" },
    { id: 7, title: "List Manipulation In Python", slug: "list-manipulation-python" },
          ...
          <li key={chapter.id}>
            <Link
              ...
              className={`flex items-center text-gray-700 hover:text-[#b80877] hover:bg-gray-50 p-1.5 rounded-md transition-colors text-sm ${
                chapter.slug === "introduction-to-python-modules" ? "bg-gray-50 text-[#b80877] font-medium" : ""
              }`}
            >
