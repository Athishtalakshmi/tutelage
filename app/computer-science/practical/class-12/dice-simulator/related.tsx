  ...
  const relatedResources = [
    {
      ...
      type: "theory",
      url: "/computer-science/class-12/python-revision-tour-1",
    },
    {
      id: 2,
      title: "Random Number Generation Tutorial",
      type: "video",
    ...
    },
    {
      ...
      type: "theory",
      url: "/computer-science/class-12/working-with-functions",
    },
    {
      id: 4,
      title: "Python Programming MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-12/python-programming",
    },
    {
      id: 5,
      title: "More Random Programs",
      type: "practical",
      url: "/computer-science/practical/class-11/lucky-winners",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">Try similar random number programs to strengthen your concepts.</p>
        <Link
