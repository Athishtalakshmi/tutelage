...
export default function ThreeNumberComparisonPage() {
  return (
      ...
      <div className="bg-gray-100 py-2 px-4 border-b">
        <div className="container mx-auto">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight size={14} className="mx-1" />
            <span className="text-[#1f888f] font-medium">Three Number Comparison</span>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-5">
              ...
              <div className="prose max-w-none text-sm">
                ...
                <div className="mb-6">
                  ...
                  <p>
                    To write a Python program that finds the largest among three numbers entered by the user using
                ...
                <div className="mb-6">
                  ...
                  <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <li>Compare the first number with the second and third</li>
                    <li>If the first number is greater than both, it is the largest</li>
                    <li>Otherwise, compare the second number with the third</li>
...
# print(f"Largest number is: {largest}")`}
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-gray-100 p-3 rounded-md mb-4 font-mono text-sm">
                    ...
                    <p>Enter second number: 30</p>
                    <p>Enter third number: 50</p>
                    <p>Largest number is: 50</p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p>
                    ...
                    result. The program successfully finds the largest among three numbers using conditional statements.
                  </p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <li>
                      ...
                      <p className="text-gray-600">
                        Change the comparison operators from {">="} to {"<="} or use the min() function instead of
                        max().
                      </p>
                    </li>
                    <li>
