...
export default function PythonRevisionTour2Related() {
  const relatedResources = [
    ...
    { id: 3, title: "Python Practice Questions", type: "pdf", url: "/resources/python-practice.pdf" },
    { id: 4, title: "Python MCQs", type: "link", url: "/mcqs/computer-science/class-11/python" },
  ]
