...
export default function InformaticsPracticesClass11Page() {
  // Sample chapter data
  const chapters = [
    { id: 1, title: "Computer System", slug: "computer-overview" },
    { id: 2, title: "Python Fundamentals", slug: "python-fundamentals" },
    { id: 3, title: "Flow of Control", slug: "flow-of-control" },
    { id: 4, title: "Data File Handling", slug: "functions" },
    { id: 5, title: "Satck-Data Structure", slug: "lists-and-tuples" },
    { id: 6, title: "Mysql", slug: "dictionaries-and-sets" },
    { id: 7, title: "Interface Python With MYSQL", slug: "string-manipulation" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h1 className="text-2xl font-bold mb-6 text-[#1f888f]">Informatics Practices - Class 11</h1>

              <div className="prose max-w-none">
                <p className="mb-4">
                  Welcome to the informatics Practices (065) resources for CBSE Class 11. This section provides comprehensive
                ...
                <p className="mb-4">
                  The CBSE Class 11 Informatics Practices curriculum introduces students to the fundamental concepts of
                  Informatics Practices and programming using Python. The course covers Python programming basics, data
                  structures, file handling, and computer networks.
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 mb-6">
                  ...
                  <li>Data Visualization using Python Libraries</li>
                ...
                <p className="mb-4">
                  The practical examination for Class 11 Informatices Practices tests your programming skills and
