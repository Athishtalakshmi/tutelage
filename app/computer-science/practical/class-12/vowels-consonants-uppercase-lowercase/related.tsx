...
export default function Related() {
  const relatedResources = [
    ...
    {
      id: 3,
      title: "Character Analysis Programs",
      type: "practical",
      url: "/computer-science/practical/class-12/text-file-line-by-line",
    },
    {
      id: 4,
      title: "File Operations MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-12/file-handling",
    },
    {
      id: 5,
      title: "Python String Methods PDF",
      type: "pdf",
      url: "/resources/python-string-methods.pdf",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">
          Try similar character analysis programs to strengthen your concepts.
        </p>
        <Link
