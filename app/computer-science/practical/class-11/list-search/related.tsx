...
export default function Related() {
  const relatedResources = [
    ...
    {
      id: 3,
      title: "Python Search Methods PDF",
      type: "pdf",
      url: "/resources/python-search.pdf",
    },
    {
      id: 4,
      title: "Search Algorithm MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-11/search-algorithms",
    },
    {
      id: 5,
      title: "Previous Program: List Swap",
      type: "practical",
      url: "/computer-science/practical/class-11/list-swap",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-4 p-3 bg-[#b80877]/10 rounded-md">
        <h3 className="font-medium text-[#b80877] mb-2 text-sm">Search Tips</h3>
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Use 'in' operator for simple existence checks</li>
          <li>• Handle ValueError when using index() method</li>
          <li>• Consider binary search for sorted data</li>
          <li>• Use enumerate() for index-value pairs</li>
        </ul>
      </div>

      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        <h3 className="font-medium text-[#1f888f] mb-2 text-sm">Practice More</h3>
        <p className="text-xs text-gray-600 mb-2">Try more search and list programs to improve your skills.</p>
        <Link
