...
export default function Related() {
  const relatedResources = [
    ...
    {
      id: 3,
      title: "String Operations PDF",
      type: "pdf",
      url: "/resources/string-operations.pdf",
    },
    {
      id: 4,
      title: "String Manipulation MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-11/strings",
    },
    {
      id: 5,
      title: "String Palindrome Program",
      type: "practical",
    ...
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-4 p-3 bg-[#b80877]/10 rounded-md">
        ...
        <ul className="text-xs text-gray-600 space-y-1">
          <li>• Use built-in methods like isupper(), islower()</li>
          <li>• Consider Unicode characters for international text</li>
          <li>• Optimize with single loop for multiple counts</li>
          <li>• Handle special characters appropriately</li>
        </ul>
      </div>
