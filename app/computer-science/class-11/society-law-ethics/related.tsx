  ...
  const topics = [
    {
      ...
      href: "/computer-science/class-11/computer-system-organization",
      icon: <BookOpen size={20} />,
      status: "available",
      description: "Hardware and software concepts",
    },
    {
      title: "Data Representation & Boolean Logic",
      href: "/computer-science/class-11/data-representation-boolean-logic",
      icon: <BookOpen size={20} />,
      status: "coming-soon",
      description: "Number systems and logic gates",
    },
    {
