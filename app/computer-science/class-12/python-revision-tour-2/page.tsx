...
export default function PythonRevisionTour2Page() {
  return (
      ...
      <div className="bg-gray-100 py-2 px-4 border-b">
        <div className="container mx-auto">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight size={14} className="mx-1" />
            <span className="text-[#1f888f] font-medium">Python Revision Tour 2</span>
          </div>
        </div>
      </div>
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg shadow-md p-5">
              <div className="flex justify-between items-start mb-6">
                <h1 className="text-xl font-bold text-[#1f888f]">Python Revision Tour 2</h1>
                <SimplePdfButton
                  title="Python Revision Tour 2 Notes"
                  price={59}
                  pdfUrl="/pdfs/python-revision-tour-2.pdf"
                />
              </div>
