...
export default function Related() {
  const relatedResources = [
    ...
    {
      id: 4,
      title: "Python Fundamentals MCQs",
      type: "link",
      url: "/mcqs/computer-science/class-11/python-fundamentals",
    },
    {
      id: 5,
      title: "Next Program: Number Comparison",
      type: "practical",
      url: "/computer-science/practical/class-11/number-comparison",
    },
  ]
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">Try more Python programs to strengthen your programming skills.</p>
        <Link
