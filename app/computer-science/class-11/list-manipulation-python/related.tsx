...
export default function ListsPythonRelated() {
  const relatedResources = [
    ...
    },
    {
      ...
      type: "practical",
      url: "/computer-science/practical/class-11/list-operations",
    },
    {
      id: 3,
      title: "Lists Methods Cheatsheet",
      type: "pdf",
      url: "/resources/list-methods-cheatsheet.pdf",
    },
    {
      id: 4,
      title: "Lists MCQs Practice",
      type: "link",
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sticky top-24">
      ...
      <div className="mt-3 p-3 bg-[#1f888f]/10 rounded-md">
        ...
        <p className="text-xs text-gray-600 mb-2">Try list manipulation exercises to strengthen your Python skills.</p>
        <Link
